...
function validar()
	{
		...
		var depart = document.getElementById("txtdepartment").value;

		if (Item.trim().length<1) 
		{
			alert("El campo Item aun esta vacio");
			return false;
		}

		if (depart.trim().length != depart.length) 
		{
			alert("Tienes espacios de mas en el department");
			return false;
		}

		if (depart.trim().length<1) 
		{
			alert("El campo department aun esta vacio");
			return false;
		}
	...
	function verificar_item(id) 
	    {
	    	$.getJSON("validaciones/verificar_item.php?p=" + id).done(function(datos)
	    	{
	    		if (datos[0][0]>0) 
	    		{
...
function validaredit()
	{
		...
		var depart = document.getElementById("depa").value;
		...
		if (pack.trim().length<1) 
		{
			alert("El campo pack aun esta vacio");
			return false;
		}
...
<div class="section">
	...
	<form action="index.php" method="post" id="frminsertar" name="frminsertar" autocomplete="off" onsubmit="return validar()" >
		
		<input type="hidden" id="txtid" name="txtid"  class="form-control" placeholder="ID">
		<div class="form-group">
		Item 
		<input type="text" id="txtitem" name="txtitem" class="form-control" placeholder="Item" maxlength="30" minlength="5" onblur="javascript: verificar_item(this.value)">
		</div> 
		<div class="form-group">
		Box Depth 
    ...
    <div class="form-group">
		MP Width
		<input type="number" id="txtmp_width" name="txtmp_width" class="form-control" placeholder="MP Width" maxlength="10" minlength="8">
		</div>
    <div class="form-group">
		MP Heigth
		<input type="number" id="txtmp_heigth" name="txtmp_heigth" class="form-control" placeholder="MP Heigth" maxlength="10" minlength="8">
		</div>
    <div class="form-group">
		MP Length
		<input type="number" id="txtmp_lenght" name="txtmp_lenght" class="form-control" placeholder="MP Length" maxlength="10" minlength="8">
		</div>
    <div class="form-group">
		PRE PKG BOX
